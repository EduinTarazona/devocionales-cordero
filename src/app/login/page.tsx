      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-8">
          <p className="text-center text-sm text-gray-500 mb-6">
            Inicia sesión para acceder a los devocionales de tu casa de vida
          </p>

          <button
            onClick={loginConGoogle}
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl text-sm font-semibold text-white transition-opacity hover:opacity-90"
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-xs text-gray-300">acceso seguro</span>
            <div className="flex-1 h-px bg-gray-100" />
          </div>

          <p className="text-center text-xs text-gray-400">
            Solo miembros registrados pueden acceder.<br />
            Si tienes problemas, contacta a tu líder.
          </p>
        </div>
