        ...
        <div className="max-w-xl mx-auto px-5 py-8 pb-16">
          ...
          <div className="rounded-2xl bg-white border border-gray-100 shadow-sm px-5 py-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-bold text-gray-800 text-sm">¿Necesitas hablar con el pastor?</p>
            </div>
            <p className="text-xs text-gray-500 leading-relaxed mb-4">
              Si deseas una cita, tienes una duda espiritual o necesitas asesoría pastoral,
